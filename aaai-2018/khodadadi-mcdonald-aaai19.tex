...
\begin{figure}[tb]
  ...
  \includegraphics[height=.2\textheight]{Figures/true_fitted_var}
...
\attn{Arash: Can you be more specific?}

\begin{figure}[tb]
  \centering	
  \includegraphics[height=.16\textheight]{Figures/convergence}  
  \includegraphics[height=.16\textheight]{Figures/modelComp_MAE}  
  \caption{Top: Convergence speed of linearized
    and consensus ADMM. Bottom: MAE for four models: admm\_opt: the
...
\attn{that our model is better than GARCH in estimating the variance.}
