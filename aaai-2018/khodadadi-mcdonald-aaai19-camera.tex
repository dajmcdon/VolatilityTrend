...
background radiation. Volatility estimation in natural gas/oil markets
or with financial data is another possibility. These methods can also
...
iteration per core is requires $\sim$10 seconds with $\sim$4 seconds
...
faster convergence. The timing of the estimation depends on $\lambda_t$ and $\lambda_s$ but takes between 1 and 4 hours for convergence.
